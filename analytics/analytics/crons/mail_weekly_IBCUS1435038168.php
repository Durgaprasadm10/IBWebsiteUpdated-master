...
$subject = "no cell pad no th no collapse cron Analytics - ".SITENAME." | Weekly report | ".$date1." to ".$date2;
...
if(($stmt->rowCount() > 0) && ($stmt1->rowCount() > 0) && ($stmt2->rowCount() > 0)){
	$htmlContent .= '<!doctype html>
				...
				<tr>
					...
					<td valign="top" style="padding-top:20px;padding-left:20px">
						...
						<tr><td style="border:1px solid black;">Code</td><td style="border:1px solid black;">Country</td><td style="border:1px solid black;">Clicks</td></tr>';
  ...
  <tr>
	...
	<tr>
		...
		<td valign="top">';
		$htmlContent .= '<a href="'.MAIN_URL.'/charts_weekly.php?date='.$date_for_web.'&category=Page&source=mail&customer_id='.$logininfo["customer_id"].'">Click to view on web</a><br>
						<img src="'.$fileName1.'">';
		$htmlContent .= '</td>
		<td valign="top" style="padding-top:20px;padding-left:20px">
      <table  style="border:1px solid black;">
        <tr><td style="border:1px solid black;">Code</td><td style="border:1px solid black;">Page Name</td><td style="border:1px solid black;">Clicks</td></tr>';
	...
	$htmlContent .=  '<td valign="top">
		<a href="'.MAIN_URL.'/charts_weekly.php?date='.$date_for_web.'&category=Country-City&source=mail&customer_id='.$logininfo["customer_id"].'">Click to view on web</a><br>
          ...
          <tr><td style="border:1px solid black;">Code</td><td style="border:1px solid black;">Country</td><td style="border:1px solid black;">Clicks</td></tr>';
    			...
    			foreach($country_code_city_display_array as $value){
						...
						if(count($value['cityinfo']) > 0){
							$htmlContent .=  '<table cellpadding="5" width="100%" style="border:1px solid black;"><tr><td style="border:1px solid black;">City</td><td style="border:1px solid black;">Clicks</td></tr>';
