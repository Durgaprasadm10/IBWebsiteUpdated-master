...
$logininfo["customer_id"] = "IBCUS1461206281"; 
...
$date_in_subject = date('Y-m-d', strtotime(date("Y-m-d H:s:i")));
...
$url1 = MAIN_URL.'/crons/reports_daily_duration.php?customer_id='.$logininfo["customer_id"];
...
//$mail->AddAddress("pradeep.ganapathy@ideabytes.com");
//echo $body;
//exit;
