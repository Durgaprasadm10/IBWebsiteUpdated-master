...
include "/var/www/html/analytics/analytics/classes/MonthlyReports.class.php";

$date_in_subject = date('F Y', strtotime('first day of last month'));

$subject = "test mail monthly 1 Analytics - ".SITENAME." | Monthly report | ".$date_in_subject;

  
// reports generation starts here
...
$htmlContent .='<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
				...
				<tbody>
					<tr>		
						<td valign="top">
							<a href="'.MAIN_URL.'/charts_monthly.php?date1='.$date_for_web1.'&date2='.$date_for_web2.'&category=Country&source=mail&customer_id='.$logininfo["customer_id"].'">Click to view on web</a><br>
							<img src="'.$fileName.'">';
		$htmlContent .='</td>
	...
	<tr>		
		<td valign="top">
			<a href="'.MAIN_URL.'/charts_monthly.php?date1='.$date_for_web1.'&date2='.$date_for_web2.'&category=Page&source=mail&customer_id='.$logininfo["customer_id"].'">Click to view on web</a><br>
			<img src="'.$fileName1.'">
		</td>
		<td valign="top" style="padding-top:20px;padding-left:20px">
			
         <table cellpadding="5" style="border:1px solid black;border-collapse:collapse;">
          <tr><th style="border:1px solid black;">Code</th><th style="border:1px solid black;">Page Name</th><th style="border:1px solid black;">Clicks</th></tr>';
	...
	<tr>
			...
			<td valign="top">
		<a href="'.MAIN_URL.'/charts_monthly.php?date1='.$date_for_web1.'&date2='.$date_for_web2.'&category=Country-City&source=mail&customer_id='.$logininfo["customer_id"].'">Click to view on web</a><br>
	...
	$htmlContent .= "No Reports for the month.";
}
