...
//exit;
    ...
    function addProcessCampaign($postarray) {
		...
		/* $insertProcessquery = "INSERT INTO " . CM_PROCESSLISTMAIN . "(cm_id,start_date,end_date,weekend)VALUES(:cm_id,:start_date,:end_date,:weekend)";*/
        $insert_query = $dbcon->prepare($insertProcessquery);
...
//    }
	...
	function getUniqLinkListWithHitCount($suserID,$scmID,$sStartDate,$sEndDate) {
		global $dbcon;
		...
		$query = "SELECT *,count(id) as hit_count FROM " . CM_VISITORTRACK;
		$query .= " WHERE (`user_id`= ".$suserID." AND `cm_id` = ".$scmID.")";
        ...
        $query .= " GROUP BY `cm_id`,`user_id`,`link_name`";
