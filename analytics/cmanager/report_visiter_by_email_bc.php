...
foreach ($objCList->getListWithHitCount($sStartDate, $sEndDate) as $data) {
        ...
        <td valign="top" style="padding-top:20px;padding-left:20px">
            ...
            <table cellpadding="5" style="border:1px solid black;border-collapse:collapse;margin-left:40px;">
                ...
                if (sizeof($aEmailList) > 0) {
                    ...
                    if ($iTables > 0) {
                        for ($k = 0; $k < $iTables; $k++) {
                            echo "<th style='border:1px solid black;'>Email</th><th style='border:1px solid black;'>Hit Count</th>";
                        }
                    } else {
                        echo "<th style='border:1px solid black;'>Email</th><th style='border:1px solid black;'>Hit Count</th>";
