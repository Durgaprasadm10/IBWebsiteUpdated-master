...
$url = TRACKING_URL . '/crons/report_visiterstatistics_by_campaign_week.php?customer_id='.$logininfo["customer_id"];
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, $url);
curl_setopt($ch, CURLOPT_HEADER, 0);
curl_setopt($ch, CURLOPT_NOBODY, 0);
...
//Report for Ip
$subject = "" . APPNAME . " | Weekly report(Visitor Statistics by Email Address) | " . $date_in_subject;
$url = TRACKING_URL . '/crons/report_visiter_by_email_week.php?customer_id='.$logininfo["customer_id"];
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, $url);
curl_setopt($ch, CURLOPT_HEADER, 0);
curl_setopt($ch, CURLOPT_NOBODY, 0);
