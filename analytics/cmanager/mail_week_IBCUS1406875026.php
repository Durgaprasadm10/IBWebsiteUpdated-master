...
$url = TRACKING_URL . '/report_visiterstatistics_by_campaign_week.php?customer_id='.$logininfo["customer_id"];
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, $url);
curl_setopt($ch, CURLOPT_HEADER, 0);
curl_setopt($ch, CURLOPT_NOBODY, 0);
...
$url = TRACKING_URL . '/report_visiter_by_email_week.php?customer_id='.$logininfo["customer_id"];
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, $url);
curl_setopt($ch, CURLOPT_HEADER, 0);
curl_setopt($ch, CURLOPT_NOBODY, 0);
