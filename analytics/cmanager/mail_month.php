...
$url = TRACKING_URL . '/report_visiterstatistics_by_campaign_month.php';
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, $url);
curl_setopt($ch, CURLOPT_HEADER, 0);
curl_setopt($ch, CURLOPT_NOBODY, 0);
...
//Report for Ip
$subject = "" . APPNAME . " | Monthly report(Visiter Statistics by Ip Address) | " . $date_in_subject;
$url = TRACKING_URL . '/report_visiter_by_Ip_month.php';
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, $url);
curl_setopt($ch, CURLOPT_HEADER, 0);
curl_setopt($ch, CURLOPT_NOBODY, 0);
