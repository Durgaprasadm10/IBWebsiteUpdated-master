...
echo "gayathri";
$result_sent = mail("gayathri.dendukuri@ideabytes.com", "hi", "testing");
echo "<br>";
echo "mail : ".$result_sent."<br>";
...
//exit;
	...
	//$subject = "Visit to our booth at the Broadcast India Show in Mumbai(" . $pid1 . ")";
   ...
   // $to_mail = 'mahendra.akula@ideabytes.com';
	...
	echo  "<br>hi coming to function sent mail to : ".$r." : ".$to_mail."<br>---<br>";
    $sMailStatus = '1';
