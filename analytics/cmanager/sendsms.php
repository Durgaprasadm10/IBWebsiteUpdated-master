...
class sendsms
{
	...
	function send_sms($to,$message,$dlr_url='',$type="json")
	{
		$y = $this->process_sms($to,$message,$dlr_url,$time="null",$unicode="null");
		return $y;
	}
	...
	function  process_sms($to,$message,$dlr_url="",$type="json",$time='',$unicode='')
	{  
