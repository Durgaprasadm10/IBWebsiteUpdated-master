    ...
    <div class="row-fluid">
      <div id="content" class="content span9  <?php echo $content_css;?>">
        <div class="inner-content">   
           ...
           <h4><?php echo __('New Search' , 'brad');?></h4>
           ...
           <?php  if( has_post_thumbnail()) {
			   ...
			   echo '<span class="search-type"><i class="fa-youtube"></i></span>';
		     }
			   ...
			   echo '<span class="search-type"><i class="fa-attachment"></i></span>';
		     }
		     else{
           ...
           <span><?php the_author_posts_link(); ?></span><span><?php echo get_the_date();?></span>
           </div>
           </div>
