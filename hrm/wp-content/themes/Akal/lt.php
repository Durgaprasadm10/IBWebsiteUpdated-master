...
echo do_shortcode("[tablemaster datatables='true' sql='SELECT * from wp_attendance where WorkDur __LT__ 9 AND ECode __EQ__ $user_last GROUP BY Date,ECode,Name' class='black-header-gray-alternate-rows' columns='Date,ECode,Name,AInTime,AOutTime,WorkDur,Status']"); ?>
