<?php /* Template Name: WFH STATUS REPORT */ ?>
<?php
   global $wpdb;
get_header();
...
echo do_shortcode("[tablemaster sql='SELECT * from wp_workf_home WHERE ecode = $rid' columns='ecode,from,to,noofdays,status,appliedon' class='black-header-gray-alternate-rows']"); 
 ?>
</div></div><br /><br /><br />
<?php get_footer(); ?>