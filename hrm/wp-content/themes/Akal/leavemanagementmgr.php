<?php /* Template Name: LEAVE APPLY MANAGER */ ?>
<?php
   global $wpdb;
get_header();
ob_start();
...
Optional-Holiday : <input type="radio" name="type" value="Optional-Holiday" /><br />
</td><td>
DAY<br />
<select name="day">
...
Reason *:<br /> 
<textarea name="reason" required></textarea></td></tr><tr><td>
