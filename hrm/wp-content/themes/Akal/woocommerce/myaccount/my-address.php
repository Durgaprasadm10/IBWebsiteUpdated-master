...
<div class="woocommerce-box border-box">
  <h4 class=""><span><?php echo $page_title; ?></span></h4>
  <p class="myaccount_address"> <?php echo apply_filters( 'woocommerce_my_account_my_address_description', esc_html__( 'The following addresses will be used on the checkout page by default.', 'woocommerce' ) ); ?> </p>
  ...
  <div class="row-fluid element-padding-large">
    ...
    <div class="span6 address">
      <div class="woocommerce-box">
        <header class="title">
          <h4 class=""><span><?php echo $title; ?></span></h4>
