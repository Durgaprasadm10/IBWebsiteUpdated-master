...
<div class="woocommerce-box border-box">
  <form method="post" class="lost_reset_password brad-woocommerce-form">
    ...
    <div class="clear"></div>
    <p class="form-row">
      <input type="submit" class="button  button_small" name="wc_reset_password" value="<?php echo 'lost_password' == $args['form'] ? esc_html__( 'Reset Password', 'woocommerce' ) : esc_html__( 'Save', 'woocommerce' ); ?>" />
    </p>
