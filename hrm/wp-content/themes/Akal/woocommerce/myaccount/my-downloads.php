...
<h4 class="textuppercase title style1"><span><?php echo apply_filters( 'woocommerce_my_account_my_downloads_title', esc_html__( 'Available downloads', 'woocommerce' ) ); ?></span></h4>
