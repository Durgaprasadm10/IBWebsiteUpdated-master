<?php /* Template Name: GREATER THEN MANAGER */ ?>
<?php
   global $wpdb;
get_header();
...
echo do_shortcode("[tablemaster datatables='true' sql='SELECT * from wp_attendance where WorkDur __GE__ CONVERT($sno, TIME) AND ECode IN ($user_last) GROUP BY Date,ECode,Name' class='black-header-gray-alternate-rows' columns='Date,ECode,Name,AInTime,AOutTime,WorkDur,Status']"); ?>
