<?php /* Template Name: STATUS UPDATE WFH */ ?>
<?php
   global $wpdb;
get_header();
...
$list_emp = ("SELECT * FROM wp_workf_home WHERE mgrid = '$rid' ORDER BY wfhindo DESC");
$list_emp = $wpdb->get_results($list_emp);

echo "<h2>Work From Home Details</h2>";
//echo  $rid;
echo "<table><th>Ecode</th><th>Name</th><th>From</th><th>To</th><th>Day<br />Type</th><th>No of<br />Days</th><th>Work From<br />Home Details</th><th>Status</th><th>Approve/Reject</th>";
...
echo "<td>";
echo $list_emp->workfhome_details;
echo "</td>";
...
$tda = $list_emp->to;
$ride = $list_emp->ecode;
$approve = 'http://ideabytes.com/hrm/workfhome-activate.php?ecode='.$ride.'&&from='.$sdat.'&&to='.$tda;
...
$reject = 'http://ideabytes.com/hrm/workfhome-reject.php?ecode='.$ride.'&&from='.$sdat.'&&to='.$tda;
//echo"<a href ='$reject'>Reject Leave </a>";

echo "<form action='http://ideabytes.com/hrm/workfhome-reject.php' method='GET'>";
