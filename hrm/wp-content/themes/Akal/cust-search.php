...
$list_q = mysql_query("select * from wp_attendance WHERE ECode IN ($search_string) AND Date BETWEEN '$sdat' AND '$tda' AND Status = '$stat' GROUP BY Date,ECode,Name");
