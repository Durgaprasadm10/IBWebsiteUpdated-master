...
<!-- You can start editing here. -->
   ...
   <div id="comments">
        <h4 class="title style1"><span><?php comments_number(__('No Comments', 'brad'), __('One Comment', 'brad'), __('% Comments', 'brad'));?></span></h4>
  ...
  <?php
        ...
        $comments_args = array(
			'fields' => $fields,
			'title_reply'=>'<h4 class="title style1 "><span>'. __('Leave a reply', 'brad') .'</span></h4>',
