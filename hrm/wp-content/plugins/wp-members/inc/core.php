...
echo 'alert("Fields should not empty.");'; 
echo 'window.location.href = "http://hrm.ideabytes.com/"';
echo '</script>';
	}
...
echo '<script type="text/javascript">'; 
echo 'alert("Fields should not empty.");'; 
echo 'window.location.href = "http://hrm.ideabytes.com/emp-profile/?a=pwdreset"';
echo '</script>';
	}
	}
	return;
